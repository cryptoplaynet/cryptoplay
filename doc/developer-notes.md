...
CryptoPlay Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as CryptoPlay Core, where everyone uses
...
pay attention to for reviewers of CryptoPlay Core code.

General CryptoPlay Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CryptoPlay Core uses tinyformat, which is type safe. Leave them out to avoid confusion
