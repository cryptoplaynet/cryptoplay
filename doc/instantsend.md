...
This mechanism has been integrated into Bitcore-Node-CryptoPlay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptoplaycoin/insight-api-cryptoplay#web-socket-api](https://github.com/cryptoplaycoin/insight-api-cryptoplay#web-socket-api) 
* API: [https://github.com/cryptoplaycoin/insight-api-cryptoplay#instantsend-transactions](https://github.com/cryptoplaycoin/insight-api-cryptoplay#instantsend-transactions) 
...
By default, the CryptoPlay Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CryptoPlay Core daemon:
