...
Only requiring some minor changes is cryptoplay.cpp.
...
Changes to cryptoplay.cpp
----------------------
cryptoplay.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
