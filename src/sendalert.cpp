...
2. run cryptoplayd with -printalert or -sendalert like this:
   /path/to/cryptoplayd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cryptoplay.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CryptoPlay Core:0.12.0.58/"));
