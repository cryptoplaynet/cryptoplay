...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CryptoPlayNetwork") type = CryptoPlayNetwork;
    if(strType == "CryptoPlayNetworkVariable") type = CryptoPlayNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CryptoPlayNetwork) s = "CryptoPlayNetwork";
    if(type == CryptoPlayNetworkVariable) s = "CryptoPlayNetworkVariable";
