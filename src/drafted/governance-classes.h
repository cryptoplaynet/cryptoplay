 ...
 *
 *   // network
 *   CCryptoPlayNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.cryptoplay.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCryptoPlayNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCryptoPlayNetwork(UniValue objIn)
    {
...
// // can be under: CryptoPlayNetwork
// //   -- signature requirements : Key1(User)
// class CCryptoPlayNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == CryptoPlayNetwork);
//     // }
