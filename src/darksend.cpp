...
{
    if(fLiteMode) return; // ignore all CryptoPlay related functionality
...
/*
    ...
    allow endless transaction that would bloat CryptoPlay and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("cryptoplay-privatesend");
