...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CryptoPlay Core cryptoplay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cryptoplay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptoplay transaction") + "\n" +
              "  cryptoplay-tx [options] -create [commands]   " + _("Create hex-encoded cryptoplay transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptoplay transaction
