    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CryptoPlay Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CryptoPlay Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cryptoplay-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CryptoPlay in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CTP, 0.1 CTP, 1 CTP and 10 CTP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cryptoplaycoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://cryptoplaycoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CryptoPlay Core is shutting down...") + "<br /><br />" +
