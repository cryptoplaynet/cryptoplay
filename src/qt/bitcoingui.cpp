    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CryptoPlay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CryptoPlay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptoplay: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CryptoPlay Core"), this);
    aboutAction->setStatusTip(tr("Show information about CryptoPlay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CryptoPlay Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CryptoPlay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CryptoPlay addresses"));
    ...
    openAction->setStatusTip(tr("Open a cryptoplay: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CryptoPlay Core help message to get a list with possible CryptoPlay Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CryptoPlay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoPlay network", "", count));
}
...
{
    QString strTitle = tr("CryptoPlay Core"); // default title
    ...
    // Append title to "CryptoPlay Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
